...
public class SubmitNewReviewAllYes {
	...
	@Test(priority=2)
	  public void TestSubmitNewReviewAllYes() throws InterruptedException {
...
//Enter email
				...
				cf.clickOnElement(driver, "ClickEmail");
...
//Select Consultant
				...
				cf.SendKeys(driver,"(.//*[@placeholder='Select a consultant'])","alex");	
//Click Alex Franklin in the Search List	
				cf.element(driver, ".//span[text()='Alex Franklin']").click();
				Thread.sleep(5000);
//Click Begin button
				try {
...
//Enter Contact Number
				cf.SendKeys(driver, "(.//*[text()[contains(.,'Contact number')]]//following::*[@type='text'])[1]","123456789000");	    
...
//Enter Private sector details
				cf.SendKeys(driver, "(.//*[@class[contains(.,'appmagic-textarea mousetrap')]])[5]","This Private sector is an automated message");
...
//Enter Please provide details below
				cf.SendKeys(driver, "(.//*[@class[contains(.,'appmagic-textarea mousetrap')]])[8]","This procedure is automated");
...
//Enter Please Provide details
				cf.SendKeys(driver, "(.//*[@class[contains(.,'appmagic-textarea mousetrap')]])[11]","This is an automated message");
...
//Enter Please Provide details
				cf.SendKeys(driver, "(.//*[@class[contains(.,'appmagic-textarea mousetrap')]])[12]","This is an automated message");
...
//Enter Please Provide details
				cf.SendKeys(driver, "(.//*[@class[contains(.,'appmagic-textarea mousetrap')]])[17]","This is an automated message");
//Click Behavior
...
//Enter Please Provide details
				cf.SendKeys(driver, "(.//*[@class[contains(.,'appmagic-textarea mousetrap')]])[16]","This is an automated message");
...
//Enter Please provide details of the elements which require escalation
		cf.SendKeys(driver, "(.//*[@class[contains(.,'appmagic-textarea mousetrap')]])[15]","This automated message should display in the Escalation Email sent to an Admin email");		
//Click Submit
