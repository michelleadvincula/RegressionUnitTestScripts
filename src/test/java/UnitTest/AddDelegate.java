...
//Click Manage Delegate on the menu
			   cf.clickOnElementJS(driver, "//div[@data-container-name='cmp_LeftMenu_7-container'] | //div[@data-control-id='19']");
			    cf.clickOnElement(driver, "//div[@data-container-name='cmp_LeftMenu_7-container'] | //div[@data-control-id='19']");
...
//Validate selected delegate is displayed in the Delegates panel
	String message = driver.findElement(By.xpath("//div[@data-control-id='702']//descendant::div[5]")).getText();
